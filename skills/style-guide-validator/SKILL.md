...
This skill includes a shared style guide at [references/style-guide-full.md](references/style-guide-full.md) and a terminology glossary at [references/terminology-glossary.md](references/terminology-glossary.md).
...
1. Read the bundled style guide at [references/style-guide-full.md](references/style-guide-full.md) and the terminology glossary at [references/terminology-glossary.md](references/terminology-glossary.md) before validating content.
...
1. Validate content against the guide, focusing on:
   - tone and voice
   - terminology consistency (against the glossary: approved vs forbidden terms, product names, entity capitalization)
   - heading style
